...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String shareTextTitle(Object assetName, Object yearsAgo) {
    return 'If you invested in $assetName $yearsAgo years ago, how much would it be now?';
  }

  @override
  String get shareTextFooter => 'InvestLongTerm Calculation Result';
  ...
  String investmentStartDate(Object yearsAgo) {
    return 'Start Date: $yearsAgo years ago';
  }
  ...
  String summaryRecurring(
    ...
    return 'What if you invested a total of \$$amount in $assetName $freqLabel starting $yearsAgo years ago?';
  }
